package metier.graphs.coupling;

import metier.graphs.coupling.distanceStrategy.context.NavigatorDistance;
import metier.graphs.coupling.distanceStrategy.strategy.impls.AddStrategy;
import metier.graphs.coupling.distanceTemplate.TemplateDistance;

import java.util.*;
import java.util.function.Consumer;

public class CouplingGraph extends TemplateDistance {
